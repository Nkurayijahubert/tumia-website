/**
 * Standalone serverless API file for Vercel
 * This file is completely self-contained and doesn't import anything
 * from the rest of the codebase to avoid module resolution issues.
 */
